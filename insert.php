...
<head>
    <meta charset="UTF-8">
    <title>Student Data Management - Insert Data</title>
...
//============name validation ==========
        ...
        ?>
                <form action="" enctype="multipart/form-data" method="post">
                    <div class="form-row">
                        <div class="row">
                            <input type="text" name="rnum" id="rnum" placeholder="Enter Roll Number" required>
                        </div>
                        <div class="row">
                    ...
                    <div class="form-row">
                        ...
                        <div class="row">
                            <input type="text" name="adhaar" id="adhaar" placeholder="Enter Adhaar Number" required pattern="(.){8,8}" maxlength="8">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="row my-3">
                            <select id="city" class="city" name="city">
                                ...
                                <option value="Roorkie">Roorkie</option>
                ...
                <p class="footer text-center pt-4 mt-5">Made by Akhilesh & Ritik</p>
            </div>
        </div>
